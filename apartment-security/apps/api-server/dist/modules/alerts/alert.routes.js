...
router.post('/broadcast', (0, role_middleware_1.requireRole)('MANAGER', 'COMMITTEE', 'GUARD'), (0, managerPermission_middleware_1.requireManagerPermission)('alerts'), (0, validate_middleware_1.validate)(alert_schema_1.createAlertSchema), alert_controller_1.broadcastAlert);
