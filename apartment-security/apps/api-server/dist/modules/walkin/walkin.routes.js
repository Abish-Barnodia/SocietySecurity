...
router.get('/pending', (0, role_middleware_1.requireRole)('MANAGER', 'COMMITTEE', 'GUARD'), (0, managerPermission_middleware_1.requireManagerPermission)('expected'), walkin_controller_1.getPendingWalkins);
// Resident responds
