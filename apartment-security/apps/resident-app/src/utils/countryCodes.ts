...
// ITU-T E.164 calling codes. Flag is derived from iso2 (regional indicator
// unicode trick) instead of hand-listing ~195 emoji, one less place to typo.
...
// India first (primary market for this app), then the rest alphabetically.
