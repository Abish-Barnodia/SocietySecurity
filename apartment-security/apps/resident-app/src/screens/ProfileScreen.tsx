          ...
          {(!!userProfile?.wing || !!userProfile?.flat) && (
            <View style={styles.infoBoxRow}>
              <View style={styles.infoBox}>
                <Text style={styles.infoBoxLabel}>Tower</Text>
                <Text style={styles.infoBoxValue}>{userProfile?.wing || '—'}</Text>
              </View>
              <View style={styles.infoBox}>
                <Text style={styles.infoBoxLabel}>Flat</Text>
                <Text style={styles.infoBoxValue}>{userProfile?.flat || '—'}</Text>
              </View>
            </View>
          )}
        </View>
