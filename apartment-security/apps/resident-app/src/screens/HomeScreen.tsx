        ...
        <View style={styles.statsGrid}>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statNumber}>
              {unreadAlertsCount}{unreadAlertsCount > 0 ? <View style={styles.redDot} /> : null}
            </Text>
          ...
          recentActivity.map((item) => (
            <View key={item.id} style={styles.activityCard}>
              <View style={styles.activityIconWrap}>
                <Text style={styles.activityEmoji}>{item.status === 'Exited' ? '🚪' : '➔'}</Text>
              </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.emergencyModal}>
            ...
            <TouchableOpacity style={styles.emergencyOption} onPress={() => { setEmergencyOpen(false); Linking.openURL('tel:100'); }}>
              <Text style={styles.emergencyOptionEmoji}>👮</Text>
